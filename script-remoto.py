...
token = "aoMcdBeQapJ00RwnP1MFS0sfKLjfDju7VFL5WYzi6RjJ7NoYp0rxM192tAOfwtF9FCMR7XXRtPFNbM4PqmcUug=="
org = "CIDIS-ESPOL"
bucket = "Prueba"

client = InfluxDBClient(url="http://200.126.19.83:8086", token=token)
...
while True:
	try:
		...
		for d in range(len(df)):
			...
			uv = str(random.randint(0,15))
			linea = planta + ",finca="+ finca + " " + "temperatura=" + temperatura + "," + "presion=" + presion + "," + "humedad=" + humedad + ","  + "uv=" + uv + "," + "latitud=" + str(latitud) + "," + "longitud=" + str(longitud) + " " + str(time_ns())
			print(linea)
